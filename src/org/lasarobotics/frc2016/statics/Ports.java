...
public class Ports {
    ...
    public static final int RIGHT_REAR_DRIVE_MOTOR_PORT = 1;
    ...
    // Digital IO Ports
    public static final int INTAKE_SWITCH_PORT = 1;
    public static final int ARM_TOP_LIMIT_SWITCH_PORT = 7;
    public static final int ARM_BOTTOM_LIMIT_SWITCH_PORT = 8;
}
